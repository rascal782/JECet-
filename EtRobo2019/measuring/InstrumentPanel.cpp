...
InstrumentPanel::InstrumentPanel() {
    ...
    //databank = new Databank();//Driverへ移動
}
...
/*RGB値記録*/
/*
void InstrumentPanel::logData(){
    databank->writeLogFile(color->getRed(),color->getGreen(),color->getBrue());
}
*/
/*ログファイル初期化*/
/*
void InstrumentPanel::logInit(){
